...
object FakeDataRemote {
    fun generateRemoteDummyMovies(): List<ItemEntitySameWithResponse> {
        val movies: ArrayList<ItemEntitySameWithResponse> = arrayListOf()
        movies.add(
            ItemEntitySameWithResponse(
                1,
                "A Star Is Born",
    ...
    fun generateRemoteDummyTvShows(): List<ItemEntitySameWithResponse> {
        val tvShows: ArrayList<ItemEntitySameWithResponse> = arrayListOf()
        tvShows.add(
            ItemEntitySameWithResponse(
                1,
                "Arrow",
    ...
    fun movieDetail(id: Int): ItemEntitySameWithResponse? {
        return generateRemoteDummyMovies()[id - 1]
    }

    fun tvShowDetail(id: Int): ItemEntitySameWithResponse? {
